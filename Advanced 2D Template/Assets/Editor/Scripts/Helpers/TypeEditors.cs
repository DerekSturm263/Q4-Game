...
namespace Helpers
{
    public static class TypeEditors
    {
        private static readonly Dictionary<System.Type, System.Func<Rect, SerializedProperty, object>> _typeDictionary = new()
        {
            ...
            [typeof(GameObject)] = (Rect rect, SerializedProperty prop) => EditorGUI.ObjectField(rect, " ", prop.objectReferenceValue, typeof(GameObject), false),
            [typeof(ScriptableObject)] = (Rect rect, SerializedProperty prop) => EditorGUI.ObjectField(rect, " ", prop.objectReferenceValue, typeof(ScriptableObject), false)
        };
