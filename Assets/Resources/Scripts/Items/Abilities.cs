public static class Abilities
{
    ...
    public static void Initialize()
    {
        ...
        underwaterBreath = new AbilityTutorial(0b_0000_0100, "Underwater Breath", "You can now last longer underwater!\n\nYou can now breath underwater for double the amount of time without drowning. Try exploring new areas on the map!");
    }
}
